...
export function ContactForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl bg-card p-8 text-center shadow-sm">
        ...
        <h3 className="mt-4 text-xl font-semibold text-foreground">{t('form.successTitle')}</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl bg-card p-6 shadow-sm sm:p-8">
      <h3 className="text-xl font-semibold text-foreground">{t('form.title')}</h3>
