      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative hidden lg:block">
            <div className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 p-8">
              <div className="absolute inset-4 flex items-center justify-center rounded-xl bg-card shadow-lg">
                <div className="p-8 text-center">
                  ...
                  <div className="mt-6 flex justify-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        key={i}
                        className="h-5 w-5 fill-chart-2 text-chart-2"
                        viewBox="0 0 20 20"
                      >
