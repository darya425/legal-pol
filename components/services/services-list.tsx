...
import { FileText, Briefcase, Users, Building2, ScrollText, Plane } from 'lucide-react';
...
export function ServicesList() {
  ...
  const services = [
    ...
    {
      icon: Building2,
      title: t('services.administrative_cases.title'),
      description: t('services.administrative_cases.description'),
      features: [
        t('services.administrative_cases.feature1'),
        t('services.administrative_cases.feature2'),
        t('services.administrative_cases.feature3'),
        t('services.administrative_cases.feature4'),
      ],
    },
    {
      icon: ScrollText,
      title: t('services.additional_services.title'),
      description: t('services.additional_services.description'),
      features: [
        t('services.additional_services.feature1'),
        t('services.additional_services.feature2'),
        t('services.additional_services.feature3'),
        t('services.additional_services.feature4'),
      ],
    },
  ];
    ...
    <section className="bg-background py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <span className="text-sm font-medium uppercase tracking-wider text-primary">{t('services.label')}</span>
          <h1 className="mt-4 text-balance text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-5xl">
            {t('services.title')}
          </h1>
          <p className="mx-auto mt-4 max-w-3xl text-pretty text-lg text-muted-foreground">{t('services.subtitle')}</p>
        </div>
