...
export function ServiceCard({ icon: Icon, title, description, features, imagePosition = 'left' }: ServiceCardProps) {
  const { t } = useI18n();
  ...
  return (
    ...
    >
      {/* Image/Icon Side */}
      <div className="flex items-center justify-center bg-linear-to-br from-primary/10 via-secondary to-accent/10 p-8 lg:w-2/5">
